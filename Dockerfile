...
ENV LABEL_MAINTAINER="Martinus Suherman" \
    ...
    LABEL_IMAGE_NAME="martinussuherman/alpine-tz-ep-net-sdk-31" \
    LABEL_URL="https://hub.docker.com/r/martinussuherman/alpine-tz-ep-net-sdk-31/" \
    LABEL_VCS_URL="https://github.com/martinussuherman/alpine-tz-ep-net-sdk-31" \
    LABEL_DESCRIPTION="Alpine Linux based image of .NET Core SDK 3.1 that bundles tzdata, su-exec, and some useful entrypoint scripts." \
